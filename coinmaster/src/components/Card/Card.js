...
import { AppRegistry, Dimensions, Image, View, Text, TextInput, TouchableOpacity, StatusBar, StyleSheet } from 'react-native';
...
export default class Card extends Component {
    ...
    componentWillMount() {
        cacheImages([
            require('../../../assets/card.imageset/card-front.png'),
            require('../../../assets/card.imageset/card-back.png'),
        ]);
    }
